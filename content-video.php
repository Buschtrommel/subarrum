 ...
 * video post format
 *
 * Displays posts in the video post format.
 *
...
?>
		...
		<header class="entry-header">
		 <div class="row-fluid">
		  <div class="span11">
		    <?php if (is_singular()) : ?>
		    <h1 class="hidden-phone"><i class="icon-film grey"></i> <?php the_title(); ?></h1>
		    <h3 class="visible-phone"><i class="icon-film grey"></i> <?php the_title(); ?></h3>
		    <?php else : ?>
		    <h3><i class="icon-film grey"></i> <a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h3>
		    <?php endif; ?>
		  </div>
